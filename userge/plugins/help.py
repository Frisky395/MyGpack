...
REPO_X = InlineQueryResultArticle(
    ...
    input_message_content=InputTextMessageContent(
        "**Here's how to setup Newbie-Bot1** "
    ),
    url="https://github.com/Frisky395/Newbie-Bot1",
    description="Siapkan milikmu sendiri",
    thumb_url="https://i.imgur.com/1xsOo9o.png",
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    " Newbie-Bot1 Repo", url="https://github.com/Frisky395/Newbie-Bot1"
                ),
                InlineKeyboardButton(
                    " Deploy Newbie-Bot1",
                    url=(
...
@userge.on_cmd(
    "help",
    about={"header": "Panduan untuk menggunakan perintah Newbie-Bot1"},
...
async def helpme(
    ...
    if not message.input_str:
        out_str = f"""⚙️ <b><u>(<code>{len(plugins)}</code>) Plugin(s) Available</u></b>\n\n"""
        ...
        async def wrapper(_, c_q: CallbackQuery):
            if c_q.from_user and (
                ...
                try:
                    ...
                    await c_q.answer(
                        "Maaf, Saya Tidak Memiliki Izin untuk mengedit ini 😔",
                        show_alert=True,
                    )
            else:
                user_dict = await userge.bot.get_user_dict(Config.OWNER_ID[0])
                await c_q.answer(
                    f"Only {user_dict['flname']} Tidak dapat mengakses ini...! Buat Newbie-Bot1 mu sendiri",
                    show_alert=True,
                )
...
"""
    ...
    async def inline_answer(_, inline_query: InlineQuery):
        ...
        if iq_user_id in Config.OWNER_ID or iq_user_id in Config.SUDO_USERS:
            ...
            if string == "syntax":
                owner = [
                    [InlineKeyboardButton(text="Contact", url="https://t.me/jxamanda")]
                ]
                results.append(
                    InlineQueryResultPhoto(
                        photo_url="https://coverfiles.alphacoders.com/123/123388.png",
                        caption="hei saya pecahkan **Frisky**",
            ...
            if string == "age_verification_alert":
                buttons = [
                    [
                        InlineKeyboardButton(
                            text="Ya saya sudah 18+",
                            callback_data="age_verification_true",
                        ),
                        InlineKeyboardButton(
                            text="tidak saya masih anak anak",
                ...
                results.append(
                    InlineQueryResultPhoto(
                        ...
                        caption="**APAKAH ANDA CUKUP TUA UNTUK INI ?**",
                        reply_markup=InlineKeyboardMarkup(buttons),
                    )
                )
                    ...
                    if "code" in r:
                        ...
                        for post in r["memes"]:
                            if "url" in post:
                                ...
                                if post["spoiler"]:
                                    captionx += " Posting ditandai sebagai SPOILER\n"
                                if post["nsfw"]:
                                    captionx += " Posting bertanda Dewasa \n"
                                buttons = [
                                    [
                                        InlineKeyboardButton(
            ...
            if string == "geass":
                results.append(
                    InlineQueryResultAnimation(
                        ...
                        caption="Untuk mengalahkan kejahatan, saya harus menjadi iblis yang lebih besar",
                    )
                )
            ...
            MAIN_MENU = InlineQueryResultArticle(
                ...
                url="https://github.com/Frisky395/Newbie-Bot1",
                description="Newbie-Bot1 Main Menu",
                thumb_url="https://i.imgur.com/1xsOo9o.png",
                reply_markup=InlineKeyboardMarkup(main_menu_buttons()),
            )
